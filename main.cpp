  ...
  Command cmd = commandMap.count(stringList[0]) ? commandMap[stringList[0]] : CMD_UNKNOWN;
   ...
   switch (cmd) {
        case CMD_SONG:
            try {
                ...
                if (flag == 0) {
                    ...
                    //debug text: cout << "Invalid Input: SongId cannot be " << stringList[1] << endl;
                }
                else {
        ...
        case CMD_REMOVE:
            ...
            else if(parseID(stringList[1])==-1234) {
                break;
            }

            else {
                store.removeSong(parseID(stringList[1]));
            }
        ...
        case CMD_PLAYLIST:
            if(!argTesting(3,stringList)) {
                ...
                store.addPlaylist(parseID(stringList[1]),stringList[2]);
            }
        ...
        case CMD_ADD:
            if(argTesting(3,stringList)){
                ...
                if(id1==-1234||id2==-1234) {
                    break;
                }

                else {
                    store.addSongToPlaylist(id1,id2);
                }
                break;
            }
            break;
        case CMD_DROP:
            if(argTesting(3,stringList)) {
                ...
                if(id1==-1234||id2==-1234) {
                    ...
                    store.removeSongFromPlaylist(id1,id2);
                }
        ...
        case CMD_SEESONG:
            if(!argTesting(2,stringList)) {
                ...
                store.seeSong(parseID(stringList[1]));
            }
        ...
        case CMD_SEEPLAYLIST:
            if(!argTesting(2,stringList)) {
                ...
                store.displaySongsInPlaylist(parseID(stringList[1]));
            }
        ...
        case CMD_DELETEPLAYLIST:
            if(!argTesting(2,stringList)) {
                ...
                store.removePlaylist(parseID(stringList[1]));
            }
        ...
        case CMD_COPYPLAYLIST:
            if(argTesting(4,stringList)) {
                ...
                if(id1==-1234||id2==-1234) {
                    ...
                    store.copyPlaylist(id1,id2,stringList[3]);
                }
        ...
        case CMD_RENAMEPLAYLIST:
            if(!argTesting(3,stringList)) {
                ...
                store.renamePlaylist(parseID(stringList[1]),stringList[2]);
            }
